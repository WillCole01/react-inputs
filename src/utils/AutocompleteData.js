...
export const grammars = { // the possible grammars (see those used below)
...
export const argument_mappings = { // a dictionary of dictionaries to hold any arguments that might need mapping for any of the grammar_templates_dict combinations
...
export const argument_validations = {
